        ...
        <Card class="no-shadow">
            <CardContent>
                <div class:disabled={isDisabled} class="container-fluid">
                    ...
                    <div class="row pt-4">
                        <FormField class="w-100">
                            <Checkbox bind:checked={() => styling.objectImgObjectFillIsOn?? false, (e) => styling.objectImgObjectFillIsOn = e} />
                            {#snippet label()}
                                Object Fit Is On
                            {/snippet}
                        </FormField>
                        ...
                        <div class="col-12">                                
                            <Select class="mb-4" bind:value={() => styling.objectImgObjectFillStyle?? '', (e) => styling.objectImgObjectFillStyle = e} label="Object Fill" variant="filled">
