...
<script lang="ts">
    ...
    import { app, currentComponent, currentTheme, dlgVariables, snackbarVariables, bgmVariables, bgmPlayer, downloadAsImage, loadFromDisk, cleanActivated, checkPointEnable } from '$lib/store/store.svelte';
